...
import ru.itis.kpfu.eduard_harahashyan.controllers.db.AccountDAO;
import ru.itis.kpfu.eduard_harahashyan.models.AccountManager;
...
public class Login extends HttpServlet {
    ...
    private void makeAttributes(HttpSession s, String login) {
        ...
        s.setAttribute("cart", new Bucket());
    }
}
